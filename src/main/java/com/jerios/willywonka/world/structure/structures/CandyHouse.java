package com.jerios.willywonka.world.structure.structures;
...
public class CandyHouse extends Structure<NoFeatureConfig> {

    public CandyHouse(Codec<NoFeatureConfig> p_i231997_1_) {
        super(p_i231997_1_);
    }
